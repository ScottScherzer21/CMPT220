...
public class problem3 {
  ...
  public static String format(long input_seconds) {
    ...
    // now that we have converted t mins and seconds, we can use mins to convert to
    // hours.
    long hours = 0;
    while (mins >= 60) {
    ...
    // if the category is less than 2 digits, add a zero in front of it and convert
    // to string
