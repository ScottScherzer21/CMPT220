...
public class problem3 {
  ...
  public static void main(String[] args) {
    ...
    // u is a coefficient of friction (u is small for a smooth surface and large for
    // a rough surface)
    // m is the object’s mass in kilograms (kg)
    // g is the acceleration due to gravity, which is a constant 9.8 m/s (meters per
    // square second)
