...
public class Problem1 {
  ...
  /*
   * (Split a string) Write the following method that splits a string into
   * substrings using delimiter characters.
   * 
   * public static ArrayList<String> split(String s, String delimiters);
   * 
   * For example, split("AB#C D?EF#45", "# ?") returns a vector containing AB, C,
   * D, EF, and 45.
   * Write a test program that prompts the user to enter a string and delimiters
   * and displays the substrings
   * separated by a space. (You are not allowed to use the regex for splitting a
   * string in this
   * exercise.)
   */
