...
public class problem2 {
    ...
    public static ArrayList<Integer> m2(int i, double weightLimit, double[] w){
        ...
        //Check for valid input first.
        //check if i is less than or equal to 0, or the weight limit is less than or equal to zero.
        //if either of those are true it is impossible to proceed. Return m as null
        if (i <= 0 || weightLimit <= 0){
        ...
        //if the the remaining list objects add up to the max weight,put them in the bag 
        int d = 0;
        int f = 1;
