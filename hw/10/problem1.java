...
public class problem1 {
    ...
    public static void main(String[] args) {
        Time time = new Time("331 34 674");

        System.out.println(Time.getHours(Time.hour));
        System.out.println(Time.getMinute(Time.minute,Time.second));
        System.out.println(Time.getSecond(Time.second));
        System.out.println(Time.elapsed_seconds(Time.hour, Time.minute, Time.second));

        //System.out.print("Enter time1 (hour minute second): ");
        //String input_string2 = input.next();
    }
}
