...
public class problem1 {
  ...
  public static void main(String[] args) throws CloneNotSupportedException {
    ...
    String time2str = Time.toString(Time.getHours(Time.hour), Time.getMinute(Time.minute, Time.second),
    ...
    // implement getsecond method after we populated the other instances with the
    // raw data
    time2.second = Time.getSecond(time2.second);

    // now that we correctly populated the instances, we can plug them into our Time
    // methods.
