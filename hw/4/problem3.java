...
public class problem3 {
   ...
   * A gene is a substring of a genome that starts after a triplet ATG and ends
   * before a triplet TAG, TAA,
   * or TGA. Furthermore, the length of a gene string is a multiple of 3, and the
   * gene does not contain any
   * of the triplets ATG, TAG, TAA, or TGA.
   * 
   * Write a program that prompts the user to enter a genome and displays all
   * genes in the genome.
   * 
