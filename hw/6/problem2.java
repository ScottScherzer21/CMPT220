...
public class problem2 {
  ...
  /*
   * 2. (Occurrences of each digit in a string) Write a method that counts the
   * occurrences of each digit in a
   * string using the following header:
   * 
   * public static int[] count(String s)
   * 
   * The method counts how many times a digit appears in the string. The return
   * value is an array of
   * ten elements, each of which holds the count for a digit. For example, after
   * executing int[] counts
   * = count("12203AB3"), counts[0] is 1, counts[1] is 1, counts[2] is 2, and
   * counts[3] is 2. Write a
