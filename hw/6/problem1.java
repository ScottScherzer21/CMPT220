...
public class problem1 {
  ...
  public static void main(String[] args) {
    /*
     * (Area of a polygon) Write a program that prompts the user to enter the points
     * of a convex polygon and
     * display its area. Assume that the polygon has six end points and the points
     * are entered clockwise. For
     * the definition of a convex polygon, see
     * http://www.mathopenref.com/polygonconvex.html. Hint:
     * the total area of a polygon is the sum of the areas of the small triangles as
     * shown in Figure 1.
     */
