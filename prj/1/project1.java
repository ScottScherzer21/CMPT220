...
public class project1 {
  ...
  public static void main(String[] args) {
    ...
    // now, once a * has been printed, the loop searches for a new y value to add an
    // asterick for it will still...
    ...
    // while y is less then the len of the str array, add a str element to the new
    // int array.
    for (int y = 0; y < len; y++) {
