...
public class project3 {
    ...
    private static BabyName findName(String name, int year, ArrayList<BabyName> names) {
        ...
        // if the answer isnt found within the file, the object "Answer" will remain
        // null
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        /*
         * String name = "Javier"; String gender = "M"; int year = 2010;
         */
...
class BabyName {
    String rank, boyname, boyname_frequency, girlname, girlname_frequency;
}
